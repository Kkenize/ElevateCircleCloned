/*
  ...
  2. Security
    ...
    - Add policies for:
      ...
      - Anyone can create discussions (since we're using email list signup)
...
-- Allow anyone to create discussions (we'll validate email list signup in the application)
